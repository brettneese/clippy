...
code with visible delimiters, links, headings, and one trailing list to the
native formatting supported by Office Assistant balloons. The XP shim reaches
the server through QEMU/UTM's host gateway at `10.0.2.2:3210`.
